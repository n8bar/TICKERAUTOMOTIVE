...
<html lang="en">
    <head>
        ...
        <link rel="canonical" href="dining.php">
        ...
        <meta name="twitter:title" content="Dining - Ticker Automotive">
        ...
        <meta property="og:title" content="Dining - Ticker Automotive">
    ...
    <body class="dining-page">
        ...
        <main class="dining-main">
            <section class="dining-hero">
                <div class="container dining-hero-inner">
                    <h1 class="dining-title">Dining</h1>
                    <p class="dining-subtitle">
