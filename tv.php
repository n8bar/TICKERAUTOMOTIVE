...
<html lang="en">
    <head>
        ...
        <link rel="canonical" href="tv.php">
        ...
        <meta name="twitter:title" content="TV - Ticker Automotive">
        ...
        <meta property="og:title" content="TV - Ticker Automotive">
    ...
    <body class="tv-page">
        ...
        <main class="tv-main">
            <section class="tv-hero">
                <div class="container tv-hero-inner">
                    <h1 class="tv-title">TV</h1>
                    <p class="tv-subtitle">
