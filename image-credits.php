...
<html lang="en">
    <head>
        ...
        <link rel="canonical" href="image-credits.php">
        ...
        <link rel="stylesheet" href="image-credits.css">
        <meta property="og:type" content="website">
        <title>
            Image Credits - Ticker Automotive
        </title>
        ...
        <meta name="twitter:title" content="Image Credits - Ticker Automotive">
        ...
        <meta property="og:title" content="Image Credits - Ticker Automotive">
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-ME7X83EBJH"></script>
    </head>
    <body class="image-credits-page">
        <?php include __DIR__ . '/includes/site-header.php'; ?>
        <main class="image-credits-main">
            <section class="image-credits-hero">
        ...
        <script src="image-credits.js" defer></script>
    </body>
</html>
