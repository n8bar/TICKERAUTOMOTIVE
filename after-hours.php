...
<html lang="en">
    <head>
        ...
        <link rel="canonical" href="after-hours.php">
        ...
        <link rel="stylesheet" href="after-hours.css">
        <meta property="og:type" content="website">
        <title>
            After Hours - Ticker Automotive
        </title>
        ...
        <meta name="twitter:title" content="After Hours - Ticker Automotive">
        ...
        <meta property="og:title" content="After Hours - Ticker Automotive">
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-ME7X83EBJH"></script>
    </head>
    <body class="after-hours-page">
        <?php include __DIR__ . '/includes/site-header.php'; ?>
        <main class="after-hours-main">
            <section class="after-hours-hero">
        ...
        <script src="after-hours.js" defer></script>
    </body>
</html>
