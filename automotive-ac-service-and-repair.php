...
<html lang="en">
    <head>
        ...
        <link rel="canonical" href="automotive-ac-service-and-repair.php">
        ...
        <link rel="stylesheet" href="automotive-ac-service-and-repair.css">
        <meta property="og:type" content="website">
        <title>
            Automotive AC Service and Repair - Ticker Automotive
        </title>
        ...
        <meta name="twitter:title" content="Automotive AC Service and Repair - Ticker Automotive">
        ...
        <meta property="og:title" content="Automotive AC Service and Repair - Ticker Automotive">
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-ME7X83EBJH"></script>
    </head>
    <body class="automotive-ac-service-and-repair-page">
        <?php include __DIR__ . '/includes/site-header.php'; ?>
        <main class="automotive-ac-service-and-repair-main">
            <section class="automotive-ac-service-and-repair-hero">
                <div class="container automotive-ac-service-and-repair-hero-inner">
                    <h1 class="automotive-ac-service-and-repair-title">Automotive AC Service and Repair</h1>
                    <p class="automotive-ac-service-and-repair-subtitle">
        ...
        <script src="automotive-ac-service-and-repair.js" defer></script>
    </body>
</html>
