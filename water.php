...
<html lang="en">
    <head>
        ...
        <link rel="canonical" href="water.php">
        ...
        <meta name="twitter:title" content="Water - Ticker Automotive">
        ...
        <meta property="og:title" content="Water - Ticker Automotive">
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-ME7X83EBJH"></script>
    </head>
    <body class="water-page">
        <?php include __DIR__ . '/includes/site-header.php'; ?>
        <main class="water-main">
            <section class="water-hero">
                <div class="container water-hero-inner">
                    <h1 class="water-title">Water</h1>
                    <p class="water-subtitle">
