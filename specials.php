...
<html lang="en">
    <head>
        ...
        <link rel="canonical" href="specials.php">
        ...
        <meta name="twitter:title" content="Specials - Ticker Automotive">
        ...
        <meta property="og:title" content="Specials - Ticker Automotive">
    ...
    <body class="specials-page">
        ...
        <main class="specials-main">
            <section class="specials-hero">
                <div class="container specials-hero-inner">
                    <h1 class="specials-title">Specials</h1>
                    <p class="specials-subtitle">
        ...
        <script src="specials.js" defer></script>
    </body>
</html>
