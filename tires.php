...
<html lang="en">
    <head>
        ...
        <link rel="canonical" href="tires.php">
        ...
        <meta name="twitter:title" content="Tires - Ticker Automotive">
    ...
    <body class="tires-page">
        ...
        <script src="tires.js" defer></script>
    </body>
</html>
