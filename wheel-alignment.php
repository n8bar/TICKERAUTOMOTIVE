...
<html lang="en">
    <head>
        ...
        <link rel="canonical" href="wheel-alignment.php">
        ...
        <link rel="stylesheet" href="wheel-alignment.css">
        <meta property="og:type" content="website">
        <title>
            Wheel Alignment - Ticker Automotive
        </title>
        ...
        <meta name="twitter:title" content="Wheel Alignment - Ticker Automotive">
        ...
        <meta property="og:title" content="Wheel Alignment - Ticker Automotive">
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-ME7X83EBJH"></script>
    </head>
    <body class="wheel-alignment-page">
        <?php include __DIR__ . '/includes/site-header.php'; ?>
        <main class="wheel-alignment-main">
            <section class="wheel-alignment-hero">
                <div class="container wheel-alignment-hero-inner">
                    <h1 class="wheel-alignment-title">Wheel Alignment</h1>
                    <p class="wheel-alignment-subtitle">
        ...
        <script src="wheel-alignment.js" defer></script>
    </body>
</html>
