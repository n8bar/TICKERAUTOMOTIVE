...
<html lang="en">
    <head>
        ...
        <link rel="canonical" href="hotel.php">
        ...
        <meta name="twitter:title" content="Hotel - Ticker Automotive">
        ...
        <meta property="og:title" content="Hotel - Ticker Automotive">
    ...
    <body class="hotel-page">
        ...
        <main class="hotel-main">
            <section class="hotel-hero">
                <div class="container hotel-hero-inner">
