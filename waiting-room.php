...
<html lang="en">
    <head>
        ...
        <link rel="canonical" href="waiting-room.php">
        ...
        <title>
            Waiting Room - Ticker Automotive
        </title>
        ...
        <meta name="twitter:title" content="Waiting Room - Ticker Automotive">
    ...
    <body class="waiting-room-page">
        ...
        <script src="waiting-room.js" defer></script>
    </body>
</html>
