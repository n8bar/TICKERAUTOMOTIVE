...
<html lang="en">
    <head>
        ...
        <link rel="canonical" href="play-area.php">
        ...
        <link rel="stylesheet" href="play-area.css">
        <meta property="og:type" content="website">
        <title>
            Play Area - Ticker Automotive
        </title>
        ...
        <meta name="twitter:title" content="Play Area - Ticker Automotive">
        ...
        <meta property="og:title" content="Play Area - Ticker Automotive">
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-ME7X83EBJH"></script>
    </head>
    <body class="play-area-page">
        <?php include __DIR__ . '/includes/site-header.php'; ?>
        <main class="play-area-main">
            <section class="play-area-hero">
                <div class="container play-area-hero-inner">
                    <h1 class="play-area-title">Play Area</h1>
                    <p class="play-area-subtitle">
        ...
        <script src="play-area.js" defer></script>
    </body>
</html>
